        ...
        if (product.categoryId) {
          if (product.description) {
            if (product.product_picture) {
              ...
              this.data.error('Veuillez selectionner une image produit');
            }
          } else {
            this.data.error('Veuillez entrer une description');
          }
        } else {
          this.data.error('Veuillez selectionner une catégorie');
        }
      } else {
        this.data.error('Veuillez entrer un prix moyen');
      }
    } else {
      this.data.error('Veuillez entrer un titre');
    }
  }
